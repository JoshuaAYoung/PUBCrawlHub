...
function toggler() {
  ...
  toggle.innerHTML = picker.destroyed
    ? "Restore <code>rome</code> instance!"
    : "Destroy <code>rome</code> instance!";
}
...
rome(exe, {
  dateValidator: rome.val.only([["2014-08-01", "2014-08-15"], "2014-08-22"]),
});
